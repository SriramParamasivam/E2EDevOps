...
const SecurityPipelineDummy = () => {
  const dummyElements = [
    ...
    },
    {
      ...
      style: { backgroundColor: 'var(--sapButton_Negative_Background)' },
    ...
    },
    {
      ...
      style: { backgroundColor: 'var(--sapNeutralColor)' },
...
export default SecurityPipelineDummy;
